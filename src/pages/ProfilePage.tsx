          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
              <Avatar className="w-24 h-24">
                <AvatarImage src={profile?.avatar_url || "https://api.dicebear.com/7.x/personas/svg?seed=" + (user?.email || "")} alt="Profile" />
                <AvatarFallback>{profile?.username ? profile.username.substring(0, 2).toUpperCase() : "UN"}</AvatarFallback>
              </Avatar>
      ...
      <Card className="mb-8 border-2 border-dashed border-finny-purple/30">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <MessageCircle className="text-finny-purple" />
            Personalized Financial Advice
          </CardTitle>
          <CardDescription>
            This section will contain AI-powered personalized advice based on your profile
          </CardDescription>
        </CardHeader>
        <CardContent className="flex items-center justify-center min-h-32 bg-gray-50">
          <p className="text-muted-foreground text-center">
            LLM integration placeholder - personalized financial advice will appear here
          </p>
        </CardContent>
      </Card>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Button className="bg-finny-purple hover:bg-finny-purple-dark">
                    Save Preferences
                  </Button>
                </div>
              </div>
